Feature: Flight Emissions Calculations
  ...
  Scenario: Calculations from default
    ...
    Then the emission value should be within "0.1" kgs of "37.3"
  ...
  Scenario Outline: Calculations from date and timeframe
    ...
    Examples:
      ...
      | 2009-06-25 | 2009-01-01/2009-12-31 | 37.3     |
  ...
  Scenario: Calculations from cohort based on origin
    ...
    When emissions are calculated
    Then the emission value should be within "0.1" kgs of "93.5"
  ...
  Scenario: Calculations from fuel type
    ...
    When emissions are calculated
    Then the emission value should be within "0.1" kgs of "74.6"
