...
require_or_fail('jeweler', 'Jeweler (or a dependency) not available. Install it with: gem install jeweler') do
  Jeweler::Tasks.new do |gem|
    ...
    gem.add_development_dependency 'sniff', '~>0.2.1' unless ENV['LOCAL_SNIFF']
    gem.add_development_dependency 'fastercsv'
    gem.add_dependency 'emitter', '~>0.1.6' unless ENV['LOCAL_EMITTER']
    gem.add_runtime_dependency 'earth', '~>0.2.5' unless ENV['LOCAL_EARTH']
  end
